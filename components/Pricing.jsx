      ...
      <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
        {props.popular && (
          <div className="absolute top-0 right-0 mr-6 -mt-4">
            <div className="inline-flex items-center text-xs font-semibold py-1.5 px-3 bg-emerald-500 text-white rounded-full shadow-sm shadow-slate-950/5">Más Popular</div>
          </div>
        )}
        <div className="mb-5">
          <div className="text-slate-900 dark:text-slate-200 font-semibold mb-1">{props.planName}</div>
          <div className="inline-flex items-baseline mb-2">
            <span className="text-slate-900 dark:text-slate-200 font-bold text-3xl">S/</span>
          ...
          <a className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-[#BE7DF6] px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-[#9327F0] focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0">
            Adquirir Plan
          </a>
        </div>
        <div className="text-slate-900 dark:text-slate-200 font-medium mb-3">Incluye:</div>
    ...
    <div>
      ...
      <div className="flex justify-center max-w-[14rem] m-auto mb-8 lg:mb-16">
        <div className="relative flex w-full p-1 bg-white dark:bg-slate-900 rounded-full">
          <span className="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
            <span className={`absolute inset-0 w-1/2 bg-[#9327F0] rounded-full shadow-sm shadow-indigo-950/10 transform transition-transform duration-150 ease-in-out ${yearly ? 'translate-x-0' : 'translate-x-full'}`}></span>
          </span>
          <button
          ...
          >
            Anual <span className={`${yearly ? 'text-indigo-200' : 'text-slate-400 dark:text-slate-500'}`}>-20%</span>
          </button>
          <button
      ...
      <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        <PricingTab
          yearly={yearly}
          planName="Básico"
          price={{ yearly: 20, monthly: 25 }}
          planDescription="Comencemos de a pocos. Visibilidad básica para rentar 1 habitación."
          features={[
            '1 Anuncio en web',
            'Destacado en web (15 días)',
            'Posts en Instagram & Facebook',
            '1 Story en Instagram & Facebook',
          ]}
        />
        ...
        <PricingTab
          ...
          popular={true}
          planName="Estándar"
          price={{ yearly: 40, monthly: 50 }}
          planDescription="Todo lo que incluye el Plan Básico y más. Publica entre 1 - 3 habitaciones."
          features={[
            'Hasta 3 anuncios en web',
            'Destacado en web (25 días)',
            'Posts en Instagram, Facebook & TikTok',
            '3 Stories en Instagram & Facebook',
            'Meta Ads durante 3 días',
          ]}
        />
        ...
        <PricingTab
          yearly={yearly}
          planName="Premium"
          price={{ yearly: 64, monthly: 80 }}
          planDescription="El más completo. Publica las habitaciones que quieras, cuando quieras."
          features={[
            'Anuncios Ilimitados',
            'Destacado en web todo el mes',
            'Posts en Instagram, Facebook & TikTok',
            '6 Stories en Instagram & Facebook',
            'Meta Ads durante 7 días',
            'Fotos profesionales del inmueble',
          ]}
        />
